...
public class Instrumento {
	...
	public boolean equals(Object o) {
		...
		Instrumento oo = (Instrumento) o;
		return Objects.equals(id, oo.id) &&
			Objects.equals(nombre, oo.nombre) &&
			Objects.equals(categoria, oo.categoria) &&
			Objects.equals(descripcion, oo.descripcion);
	}
	...
	public String toString() {
		return "Instrumento [id=" + id + ", nombre=" + nombre + ", categoria=" + categoria + ", descripcion="
				+ descripcion + "]";
	}
